...
function Decide(props) {
  ...
  if (state.isLoggedIn == false) {
    return __jsx("div", {
      ...
      __self: this
    }, "state falseyyyy ", state.isLoggedIn), __jsx(Navigation, {
      title: "Dashboard",
      page: "/login",
      __source: {
        fileName: _jsxFileName,
    ...
    if (state.isVolunteer == true) {
      return __jsx("div", {
        ...
        __self: this
      }, "state ", state.isLoggedIn), __jsx(Navigation, {
        title: "Dashboard",
        page: "/userDash",
        __source: {
          fileName: _jsxFileName,
...
//# sourceMappingURL=orgDash.js.7615d238ad291e6b54ca.hot-update.js.map