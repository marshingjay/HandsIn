...
var updatePage = function updatePage(state, newState, forceUpdate) {
  if (newState) {
  ...
  toggleLoggedIn(state, newState, forceUpdate);
};
...
var toggleType = function toggleType(state, newState, forceUpdate) {
  state.type = newState;
  toggleLoggedIn(state, state.isLoggedIn, forceUpdate); // forceUpdate();
};
...
var Login = function Login() {
  ...
  return __jsx(_components_TheLayout__WEBPACK_IMPORTED_MODULE_0__["default"], {
    ...
    onChange: function onChange(e) {
      return updatePage(state, e.target.value, forceUpdate);
    },
    __source: {
      fileName: _jsxFileName,
      lineNumber: 49
...
//# sourceMappingURL=login.js.2eee72ebd20065784131.hot-update.js.map