...
var toggleLoggedIn = function toggleLoggedIn(state, setState) {
  if (state.isLoggedIn) {
    setState({
      isLoggedIn: false
    });
...
var Login = function Login() {
  ...
  var setState = Object(react__WEBPACK_IMPORTED_MODULE_1__["useContext"])(_components_GlobalContext__WEBPACK_IMPORTED_MODULE_2__["GlobalContext"]);
  var state = setState.state; // const {isLoggedIn, isVolunteer} = state;
...
//# sourceMappingURL=login.js.d1784829022404ccae6a.hot-update.js.map