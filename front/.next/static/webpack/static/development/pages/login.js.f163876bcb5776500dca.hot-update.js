...
/*!*************************************!*\
  !*** ./components/GlobalContext.js ***!
  \*************************************/
/*! exports provided: GlobalStateContext, GlobalProvider */
...
var GlobalChangeStateContext = react__WEBPACK_IMPORTED_MODULE_1___default.a.createContext();
...
function GlobalProvider(_ref) {
  ...
  var _React$useReducer = react__WEBPACK_IMPORTED_MODULE_1___default.a.useReducer(changeStateFunc, state),
      ...
      changeState = _React$useReducer2[1];
  ...
  return __jsx(GlobalStateContext.Provider, {
    ...
    __self: this
  }, __jsx(GlobalChangeStateContext.Provider, {
    value: changeState,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 20
...
var toggleLoggedIn = function toggleLoggedIn(state, setaState) {
  if (state.isLoggedIn) {
    setState({
      isLoggedIn: false
    });
...
var Login = function Login() {
  ...
  var state = Object(react__WEBPACK_IMPORTED_MODULE_1__["useContext"])(_components_GlobalContext__WEBPACK_IMPORTED_MODULE_2__["GlobalStateContext"]);
  ...
  return __jsx(_components_TheLayout__WEBPACK_IMPORTED_MODULE_0__["default"], {
    ...
    onChange: function onChange() {
      return toggleLoggedIn(state, setState);
    },
    __source: {
      fileName: _jsxFileName,
      lineNumber: 34
...
//# sourceMappingURL=login.js.f163876bcb5776500dca.hot-update.js.map