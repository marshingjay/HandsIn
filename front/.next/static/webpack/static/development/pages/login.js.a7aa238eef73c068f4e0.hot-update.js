...
function toggleType(state, newState, forceUpdate) {
  state.type = newState;
  toggleLoggedIn(state, state.isLoggedIn, forceUpdate); // updatePage(state);
  // forceUpdate();
}
...
//# sourceMappingURL=login.js.a7aa238eef73c068f4e0.hot-update.js.map