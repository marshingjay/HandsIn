...
var setState = function setState(state, newValue) {
  _this.setState({
    state: newValue
  });
};
...
var GlobalProvider = function GlobalProvider(props) {
  var _useReducer = Object(react__WEBPACK_IMPORTED_MODULE_7__["useReducer"])(function (state, action) {
    switch (action.type) {
      case 'change':
      ...
      state = _useReducer[0],
      dispatch = _useReducer[1]; // const [state, setState] = useState({});
...
//# sourceMappingURL=orgDash.js.3209ac89cf0d24cc4c82.hot-update.js.map