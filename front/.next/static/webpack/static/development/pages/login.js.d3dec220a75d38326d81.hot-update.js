...
var toggleLoggedIn = function toggleLoggedIn(dispatch) {
  if (data.isLoggedIn) {
    dispatch({
      isLoggedIn: false
    });
...
var toggleType = function toggleType(dispatch) {
  if (data.isVolunteer) {
    dispatch({
      isVolunteer: false
    });
...
//# sourceMappingURL=login.js.d3dec220a75d38326d81.hot-update.js.map